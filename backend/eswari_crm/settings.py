...
INSTALLED_APPS = [
    ...
    "teams",          # Teams app for ASE Technologies
    "tech_projects",  # Technical team projects and tasks
    "app_settings",
    "notifications",
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 50,  # Increased from 20 for better performance
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:8080,http://127.0.0.1:8080,https://eswariconnects.com,https://www.eswariconnects.com',
